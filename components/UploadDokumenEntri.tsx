...
export function UploadDokumenEntriCard({ title, url }: Props) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Upload Dokumen Entri {title}</DialogTitle>
        </DialogHeader>

        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-3">
            <p className="text-sm font-medium">Upload File .xlsx</p>
            <Input
              type="file"
              ref={inputRef}
              accept=".xlsx"
          ...
          <div className="space-y-3">
            ...
            <Button variant="outline" className="w-full" asChild>
              <a href="/?hal=upload" target="_blank">
